...
both structured lab results, monitor readings and unstructured physician, operating notes. 
...
that takes in a query string and return all documents in the corpus that contain at 
